...
function ListItemEmailAccount({emailAccount}) {
    ...
    return (<ListItemButton selected={activeEmailAccount.emailAddress === emailAccount.emailAddress} onClick ={
        function() {
            setActiveEmailAccount(emailAccount);
        }
    }>
        <ListItemIcon><AccountBoxIcon /></ListItemIcon>
       <ListItemText primary={emailAccount.emailAddress} secondary={emailAccount.description} />
        </ListItemButton>);
}
...
export default function AccountSelector() {
    ...
    return (
        <List component="nav">
            ...
            {emailAccountList.map(
                function (emailAccount) {
                    return (
                        <ListItemEmailAccount key={emailAccount.emailAddress} emailAccount={emailAccount} />
                    );
                }
            )}
        </List>
